...
import { Zap, CheckCircle, Award, RotateCcw, GitBranch, Package, Ship, BarChart3, ExternalLink, Filter, Clock } from 'lucide-react'
...
export default function ProfilePage() {
  ...
  // Certification Roadmap filtering logic
